...
class M3Light(bpy.types.PropertyGroup):
    ...
    unknownAt72 = bpy.props.FloatProperty(default=0.0, name="unknownAt72", options={"ANIMATABLE"})
    unknownAt108 = bpy.props.FloatProperty(default=0.0, name="unknownAt92", options={"ANIMATABLE"})
...
class LightPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if currentIndex >= 0 and currentIndex < len(scene.m3_lights):
            ...
            layout.prop(light, "unknownAt72", text="unknownAt72")
            layout.prop(light, "unknownAt108", text="unknownAt108")
