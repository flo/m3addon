...
class M3ParticleSystem(bpy.types.PropertyGroup):
    ...
    initialColor1 = bpy.props.FloatVectorProperty(default=(1.0, 1.0, 1.0, 0.5), min = 0.0, max = 1.0, name="initial color 1", size=4, subtype="COLOR", options={"ANIMATABLE"}, description="Color of the particle when it gets emitted")
    ...
    unknownColor1 = bpy.props.FloatVectorProperty(default=(1.0, 1.0, 1.0, 0.0), min = 0.0, max = 1.0, name="unknown color 1", size=4, subtype="COLOR", options={"ANIMATABLE"})
    ...
    initialColor2 = bpy.props.FloatVectorProperty(default=(1.0, 1.0, 1.0, 0.0), min = 0.0, max = 1.0, name="initial color 2", size=4, subtype="COLOR", options={"ANIMATABLE"})
    finalColor2 = bpy.props.FloatVectorProperty(default=(1.0, 1.0, 1.0, 1.0), min = 0.0, max = 1.0, name="final color 2", size=4, subtype="COLOR", options={"ANIMATABLE"})
    unknownColor2 = bpy.props.FloatVectorProperty(default=(1.0, 1.0, 1.0, 1.0), min = 0.0, max = 1.0, name="unknown color 2", size=4, subtype="COLOR", options={"ANIMATABLE"})
    partEmit = bpy.props.IntProperty(default=0, subtype="UNSIGNED", options={"ANIMATABLE"})
    ...
    unknownAt776 = bpy.props.FloatProperty(default=0.0, name="unknownAt776",options={"ANIMATABLE"})
    unknownAt796 = bpy.props.FloatProperty(default=0.0, name="unknownAt796",options={"ANIMATABLE"})
    unknownAt820 = bpy.props.FloatProperty(default=0.0, name="unknownAt820",options={"ANIMATABLE"})
    unknownAt840 = bpy.props.FloatProperty(default=0.0, name="unknownAt840",options={"ANIMATABLE"})
    unknownAt864 = bpy.props.FloatProperty(default=0.0, name="unknownAt864",options={"ANIMATABLE"})
...
class ParticleSystemsPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if currentIndex >= 0 and currentIndex < len(scene.m3_particle_systems):
            ...
            layout.prop(particle_system, "unknownAt776", text="unknownAt776")
            layout.prop(particle_system, "unknownAt796", text="unknownAt796")
            layout.prop(particle_system, "unknownAt820", text="unknownAt820")
            layout.prop(particle_system, "unknownAt840", text="unknownAt840")
            layout.prop(particle_system, "unknownAt864", text="unknownAt864")
            layout.prop(particle_system, "unknownAt908", text="unknownAt908")
            layout.prop(particle_system, "unknownAt952", text="unknownAt952")
            layout.prop(particle_system, "unknownAt1168", text="unknownAt1168")
